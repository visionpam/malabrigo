...
import { ContractFileLinks } from "@/components/contract-file-links";
...
export default async function ContractsPage() {
  ...
  const [contracts, templates, signed, sales] = await Promise.all([
    ...
    db.contractTemplate.findMany({ orderBy: [{ code: "asc" }, { version: "desc" }], include: { _count: { select: { contracts: true } } } }),
